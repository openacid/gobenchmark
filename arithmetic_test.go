...
func BenchmarkInt64_And_ByConst_Assign(b *testing.B) {
	var s int64
	for i := 0; i < b.N; i++ {
		s += Inp1I64 & 87
	}
...
func BenchmarkInt64_And_ByVar_Assign(b *testing.B) {
	var s int64
	for i := 0; i < b.N; i++ {
		s += Inp1I64 & Inp2I64
	}
...
func BenchmarkInt64_Or_ByConst_Assign(b *testing.B) {
	var s int64
	for i := 0; i < b.N; i++ {
		s += Inp1I64 | 87
	}
...
func BenchmarkInt64_Or_ByVar_Assign(b *testing.B) {
	var s int64
	for i := 0; i < b.N; i++ {
		s += Inp1I64 | Inp2I64
	}
...
func BenchmarkInt64_Xor_ByConst_Assign(b *testing.B) {
	var s int64
	for i := 0; i < b.N; i++ {
		s += Inp1I64 ^ 87
	}
...
func BenchmarkInt64_Xor_ByVar_Assign(b *testing.B) {
	var s int64
	for i := 0; i < b.N; i++ {
		s += Inp1I64 ^ Inp2I64
	}
...
func BenchmarkFloat64_Multi_ByConst_Assign(b *testing.B) {
	var s float64
	for i := 0; i < b.N; i++ {
...
func BenchmarkFloat64_Multi_ByVar_Assign(b *testing.B) {
	var s float64
	for i := 0; i < b.N; i++ {
